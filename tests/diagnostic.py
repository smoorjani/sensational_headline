...
#
# python -m torch.distributed.run --nproc_per_node 2 --nnodes 1 diagnostic.py
#
...
#
# NCCL_DEBUG=INFO python -m torch.distributed.run --nproc_per_node 2 --nnodes 1 diagnostic.py
#
