...
def get_args():
    ...
    parser.add_argument('--save_path', type=str, default="/expanse/lustre/projects/uic333/smoorjani/sensational_headline/test_trainer", help="save path") 
    parser.add_argument('--checkpoint_name', type=str, default="checkpoint-11000", help="checkpoint name")
