...
class PersuasivenessClassifierScore(nn.Module):
    def __init__(self, model_name='bert-base-uncased', hidden_dim=768, dropout=0.2, n_classes=3):
        super(PersuasivenessClassifierScore, self).__init__()
...
if __name__ == '__main__':
    persuasive_classifier = PersuasivenessClassifierScore()

    sd = torch.load('/expanse/lustre/projects/uic333/smoorjani/persuasive_model/persuasive_model_score_sd.pth')
    new_sd = OrderedDict()
